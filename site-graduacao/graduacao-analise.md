...
* **Item 01 - Inconsistência entre validação do backend e campos do formulário <a name="item-01"></a>**
  ...
  * **Evidência: [Ver evidência](../evidencias/evidencias-site-graduacao/item01-erro-base-legal.png)** 
...
* **Item 03 - Problemas de padronização e alinhamento no header  <a name="item-03"></a>**
  ...
  * **Evidência: [Ver evidência](../evidencias/evidencias-site-graduacao/item03-icones-header.png)** 
...
* **Item 04 - Problemas de layout e validação na seção de formulário <a name="item-04"></a>**
  ...
  * **Evidência: [Ver evidência](../evidencias/evidencias-site-graduacao/item04-layout-form-e-validacao.png)** 
...
* **Item 05 - Inconsistência na navegação dos links do menu principal <a name="item-05"></a>**
  ...
  * **Evidência: [Ver evidência](../evidencias/evidencias-site-graduacao/item05-naegacao-links-menu-principal.mp4)** 
...
* **Item 06 - Elementos clicáveis sem funcionalidade nos banners principais <a name="item-06"></a>**
  ...
  * **Evidência: [Ver evidência](../evidencias/evidencias-site-graduacao/item06-itens-clicaveis-sem-funcionalidade.mp4)** 
...
* **Item 07 - Problemas de layout na seção “Conheça nossos diferenciais” <a name="item-07"></a>**
  ...
  * **Evidência: [Ver evidência](../evidencias/evidencias-site-graduacao/item07-layout-conheca-nossos-diferenciais.png)** 
...
* **Item 08 - Ajustes de espaçamento na seção “Próximos eventos” <a name="item-08"></a>**
  ...
  * **Evidência: [Ver evidência](../evidencias/evidencias-site-graduacao/item08-layout-sessao-proximos-eventos.png)** 
...
* **Item 09 - Dimensionamento excessivo dos ícones de redes sociais <a name="item-09"></a>**
  ...
  * **Evidência: [Ver evidência](../evidencias/evidencias-site-graduacao/item09-icones-footer.png)** 
...
* **Item 10 - Título sublinhado sem funcionalidade na seção de depoimentos <a name="item-10"></a>**
  ...
  * **Evidência: [Ver evidência](../evidencias/evidencias-site-graduacao/item10-titulo-sublihado.png)** 
---
